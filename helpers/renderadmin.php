	...
	public static function getLinks() {
		...
		switch ($option) {
			case 'com_phocapanorama':
				$links[]	= array('Phoca Panorama site', 'http://www.phoca.cz/phocapanorama');
				$links[]	= array('Phoca Panorama documentation site', 'http://www.phoca.cz/documentation');
				$links[]	= array('Phoca Panorama download site', 'http://www.phoca.cz/download');
			break;
