...
class PhocaPanoramaCpModelPhocaPanoramaCats extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__phocapanorama_categories` AS a');
		...
		$query->join('LEFT', '#__phocapanorama_categories AS c ON c.id = a.parent_id');
