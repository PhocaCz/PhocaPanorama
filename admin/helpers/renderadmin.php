...
class PhocaPanoramaRenderAdmin
{
	...
	public static function getLinks() {
		...
		$links =  array();
		switch ($option) {
			case 'com_phocapanorama':
				$links[]	= array('Phoca Panorama site', 'https://www.phoca.cz/phocapanorama');
				$links[]	= array('Phoca Panorama documentation site', 'https://www.phoca.cz/documentation');
				$links[]	= array('Phoca Panorama download site', 'https://www.phoca.cz/download');
			break;
